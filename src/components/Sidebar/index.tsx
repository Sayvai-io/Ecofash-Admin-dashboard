...
const menuGroups = [
  {
    ...
    menuItems: [
...

      {
        ...
        route: "#",
        children: [
          { label: "AboutDetails", route: "/about" },
          { label: "AboutReview", route: "/about_review" },
        ],
      },

      {
        ...
        route: "#",
        children: [
          { label: "ServiceDetails", route: "/service" },
          { label: "ServiceProvided", route: "/service_provided" },
          { label: "Seperate_ServiceDetails", route: "/seperate_service" },
        ],
      },
